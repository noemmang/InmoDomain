...
- **IDs numéricos del INE resueltos**: variable provincia = 115 (52 valores, uno por provincia), variable régimen = 503 (libre = 284449, protegida = 284450), variable estado = 345 (nueva = 16464, segunda mano = 16465; el valor 16463 "General" existe pero no se usa por agregar ambos estados). Catalogados en `IneMetadataCatalog.cs`.
